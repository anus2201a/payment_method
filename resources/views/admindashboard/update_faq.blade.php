                                        ...
                                        <div class="col-lg-12">
                                            <div class="row border border-5 border-dark m-auto py-2">
                                                <div class="personal-informations-from-btn col-lg-6 m-auto">
                                                    <h1 align="left"><b>Update FAQs</b></h1>
                                                </div>
                                         ...
                                         <form action="{{ route ('faq.update.store', $data->id)}}" enctype="multipart/form-data" method="POST">
                                                @csrf
                                                    ...
                                                    <div class="personal-informations-from-item-inner">
                                                        <div class="row">
                                                            <div class="col-12 col-md-12  col-lg-6">
                                                                ...
                                                                <input type="text" value="{{$data->question}}" name="question" class="form-control" required
                                                                    aria-label="Last name">
                                                            </div>
                                                            <div class="col-12 col-md-12  col-lg-6">
                                                                <label for="exampleFormControlInput1"
                                                                    class="form-label last-name ">Answer</label>
                                                                <input type="text" value="{{$data->answer}}" name="answer" class="form-control" required
                                                                    aria-label="Last name">
                                                            </div>
                                                        </div>
                                                    </div>
