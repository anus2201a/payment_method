                                        ...
                                        {{-- <div class="container-fluid"> --}}
                                            <div class="card m-auto p-auto">
                                                <div class="card-header col-lg-12 d-flex justify-content-between align-items-center">
                                                    <h4 class="card-title col-lg-10">All FAQs</h4>
                                                    {{-- <button type="submit" ">Add Member</button> --}}
                                                    <a href="{{route('faq.add')}}" class="btn-one success text-white pt-3">Add FAQs</a>
                                                </div>
                                                        ...
                                                        @foreach ($data as $faq)
                                                            <tr>
                                                                ...
                                                                <td>{{ $faq->answer }}</td>
                                                                  <td class="col-lg-2">
                                                                    <div class="col-lg-12">
                                                                    <a href="{{route('faq.update',$faq->id )}}" class="btn-one success text-white pt-3">Update</a><br>
                                                                    <a href="{{route('faq.delete', $faq->id)}}" class="btn-one danger bg-danger text-white pt-3">Delete</a>
                                                                </div></td>
                                                            </tr>
                                                        @endforeach
                                                    </tbody>
