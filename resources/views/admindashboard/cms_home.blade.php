                                                        ...
                                                        <div class="row">
                                                            <div class="col-12 col-md-12  col-lg-6">
                                                                <label for="exampleFormControlInput1"
                                                                    class="form-label last-name ">Main Heading</label>
                                                                <input type="text"
                                                                    value="{{ get_cms('section_1_heading', 'home', 'value') }} "
                                                            ...
                                                            <div class="col-12 col-md-12  col-lg-6">
                                                                ...
                                                                <input type="text" value="{!! get_cms('section_1_tittle', 'home', 'value') !!} "
                                                                    name="section_1_tittle" class="form-control" required
                                                                    aria-label="Last name">
                                                            </div>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="personal-informations-from-item-inner">
                                                        <div class="row ">
                                                            <div class="col-12 col-md-12 col-lg-6 ">
                                                                ...
                                                                <input type="text"
                                                                    value=" {!! get_cms('section_1_desc', 'home', 'value') !!}"
                                                        ...
                                                        <div class="personal-informations-from-item-inner">
                                                            <div class="row  ">
                                                                <div class="col-12 col-md-12 col-lg-6 ">
                                                                    ...
                                                                    <input type="text"
                                                                        value=" {{ get_cms('section_2_tittle', 'home', 'value') }} "
                                                                        name="section_2_tittle" class="form-control   "
                                                                        aria-label="First name">
                                                                </div>
